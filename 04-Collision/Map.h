...
public :
	...
	void Get_gridObjects(vector<LPGAMEOBJECT> &coObjectsFull,vector<LPGAMEOBJECT> &coObjectGround,vector<LPGAMEOBJECT> &coObjectsWithSimon,vector<LPGAMEOBJECT> &coObjectsWithSkill);
